...
(function () {
  ...
  const CATEGORIES = [
    {
      key: "Biryani",
      name: "Biryani",
      img: "https://spicecravings.com/wp-content/uploads/2022/06/Achari-Paneer-Biryani-Featured.jpg",
    },
    {
      key: "Pizza",
      name: "Pizza",
      img: "https://content.jdmagicbox.com/comp/jammu/g2/9999px191.x191.230625135712.c3g2/catalogue/pizza-wings-bahu-plaza-jammu-trikuta-nagar-jammu-pizza-outlets-9awg9fkgh9.jpg",
    },
    {
      key: "Chinese",
      name: "Chinese",
      img: "https://www.ohmyveg.co.uk/wp-content/uploads/2024/08/hakka-noodles-1200x1200.jpg",
    },
    {
      key: "Burger",
      name: "Burger",
      img: "https://imgmediagumlet.lbb.in/media/2025/01/6790b9b0e59da653ef5df1de_1737537968281.jpg",
    },
    {
      key: "Pav Bhaji",
      name: "Pav Bhaji",
      img: "https://greedyeats.com/wp-content/uploads/2024/01/Pav-bhaji.jpg",
    },
    {
      key: "Dosa",
      name: "Dosa",
  ...
  const DEMO_RESTAURANTS = [
    {
      id: "r1",
      name: "Dwarka Restraunt",
      categories: ["Biryani", "North Indian", "Dosa"],
      rating: 4.3,
      address: "Shirdi Nagar",
      imageUrl:
        "https://content.jdmagicbox.com/v2/comp/navi-mumbai/j3/022pxx22.xx22.131109075251.d2j3/catalogue/dwarka-restaurant-and-bar-kalamboli-navi-mumbai-north-indian-restaurants-xt92e.jpg",
    },
    {
      id: "r2",
      ...
      imageUrl:
        "https://franchisekhoj.com/wp-content/uploads/2022/05/the-biryani-house-amb-1024x1024.webp",
    },
    {
      id: "r3",
      name: "Chulbul Dhaba",
      ...
      address: "Sathe Nagar",
      imageUrl:
        "https://content.jdmagicbox.com/comp/pune/x3/020pxx20.xx20.190315192618.k8x3/catalogue/chulbul-dhaba-baner-pune-dhaba-restaurants-wutqbocpn8.jpg",
    },
    {
      id: "r4",
      name: "Hotel RadheKrishna",
      categories: ["North Indian", "Burger", "Pav Bhaji", "Dosa"],
      rating: 4.6,
      address: "Pimpri Chinchwad",
      imageUrl:
        "https://gos3.ibcdn.com/af956e1c-a14a-4328-8b76-8440535b157e.jpeg",
    },
    {
      id: "r5",
      name: "Behrouz Biryani",
      categories: ["Biryani", "Pizza"],
      rating: 4.1,
      address: "Baner",
      imageUrl:
        "https://b.zmtcdn.com/data/pictures/9/20611279/f35f0bbd748a770638f7404e973acd15_featured_v2.jpg",
    },
    {
      id: "r6",
      name: "UCOE Canteen",
      categories: ["Pav Bhaji", "Dosa", "Biryani", "Chinese"],
      rating: 4.4,
      address: "Universal College Campus",
      imageUrl:
  ...
  const DEMO_MENU = [
    ...
    },
    {
      ...
      restaurant: "The Biryani House",
      imageUrl:
        "https://www.foodiaq.com/wp-content/uploads/2024/10/Paneer-Makhani-Biryani.jpg",
    },
    ...
    {
      id: 31,
      name: "Behrouz Veg Biryani",
      price: 189,
      category: "Biryani",
      restaurant: "Behrouz Biryani",
      imageUrl:
        "https://lentillovingfamily.com/wp-content/uploads/2025/08/one-pot-vegetable-birayni-2.jpg",
    },
    ...
    },
    {
      ...
      restaurant: "Chulbul Dhaba",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7OI43z3pMact21tHJtOLsEdMQd_3PNlkO4A&s",
    },
    {
      id: 41,
      ...
      category: "Chinese",
      restaurant: "Chulbul Dhaba",
      imageUrl: "https://cdn.uengage.io/uploads/7057/image-6716-1666791013.jpg",
    },
    ...
    },
    {
      ...
      restaurant: "Hotel RadheKrishna",
      imageUrl: "https://static.toiimg.com/photo/53109843.cms",
    },
    ...
    // New: Pav Bhaji (Hotel RadheKrishna)
    {
      ...
      restaurant: "Hotel RadheKrishna",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxS9_36jgShvcXRGcfZEkbi10Kkxoz8hEbyw&s",
    },
    {
      id: 61,
      ...
      restaurant: "Hotel RadheKrishna",
      imageUrl:
        "https://instamart-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_960,w_960//InstamartAssets/Receipes/cheese_pav_bhaji.webp",
    },
    ...
    // New: Dosa (Dwarka Restraunt, Hotel RadheKrishna)
    {
      ...
      restaurant: "Dwarka Restraunt",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYH7H-KRy-dnN9To-d5TJu7dKpY3f_nr0w3Q&s",
    },
    {
      id: 71,
      name: "Plain Dosa",
    ...
    },
    {
      ...
      restaurant: "UCOE Canteen",
      imageUrl:
        "https://vps029.manageserver.in/menu/wp-content/uploads/2024/05/e9ccf813e0e7b1334af5b37ade2acbf8.jpg",
    },
    {
      id: 82,
      name: "Masala Dosa",
    ...
    {
      id: 83,
      name: "Veg Biryani (Mini)",
      price: 99,
      category: "Biryani",
      restaurant: "UCOE Canteen",
      imageUrl:
        "https://i.pinimg.com/736x/a0/b2/e7/a0b2e74b691f590ea3dbf615c1ca8bbe.jpg",
    },
    {
      id: 84,
      name: "Tripple Rice",
      ...
      restaurant: "UCOE Canteen",
      imageUrl:
        "https://vps029.manageserver.in/menu/wp-content/uploads/2024/02/images-2.jpeg",
    },
    {
      id: 85,
      name: "Scheswan Noodles",
      price: 70,
      category: "Chinese",
      restaurant: "UCOE Canteen",
      imageUrl:
  ...
  function showRestaurantsGrid() {
    if (catRestaurants) catRestaurants.style.display = "grid";
  }
  function hideRestaurantsGrid() {
    if (catRestaurants) catRestaurants.style.display = "none";
  }
  ...
  function setAuth(auth) {
    if (auth) localStorage.setItem("qc_auth", JSON.stringify(auth));
      ...
      CART = [];
      try {
        localStorage.removeItem("qc_cart_simple");
      } catch {}
      renderCart();
      updateCartBadges();
      syncMenuButtons();
  ...
  function saveCart() {
    localStorage.setItem("qc_cart_simple", JSON.stringify(CART));
  }
  function cartCount() {
  ...
  function setActiveStepper(id) {
    ACTIVE_STEPPER_ID = id;
    syncMenuButtons();
  }
  function bumpCartBadges() {
    if (cartCountEl) {
      cartCountEl.classList.add("bump");
      setTimeout(() => cartCountEl.classList.remove("bump"), 280);
    }
    if (cartCountMobileEl) {
      cartCountMobileEl.classList.add("bump");
      setTimeout(() => cartCountMobileEl.classList.remove("bump"), 280);
    }
  }
  function openCart() {
  ...
  function getSavedAddress() {
    try {
      return localStorage.getItem("qc_address") || "";
    } catch {
      return "";
    }
  }
  function setSavedAddress(addr) {
    try {
      localStorage.setItem("qc_address", addr || "");
    } catch {}
  }
      ...
      cartItemsEl.innerHTML = CART.map(
        ...
        <div class="cart-row">
          ...
          <div class="cart-right">
            ...
            <button class="remove-btn" data-act="rm" data-id="${
              i.id
            }">×</button>
          </div>
        </div>`
  ...
  function renderCategoryChips() {
    ...
    categoryRow.innerHTML = CATEGORIES.map(
      ...
      }" data-cat="${c.key}" aria-label="${c.name}" title="${
        c.name
      }" style="padding:6px;border-radius:9999px;display:inline-flex;align-items:center;justify-content:center;">
        <img src="${c.img}" alt="${
        c.name
  ...
  function renderRestaurants() {
    ...
    const list = DEMO_RESTAURANTS.filter((r) =>
      r.categories.includes(currentCategory)
    );
    ...
    if (!list.length) {
      targetGrid.innerHTML =
        '<p class="no-results">No restaurants found for this category.</p>';
      return;
    }
    targetGrid.innerHTML = "";
    list.forEach((r) => {
  ...
  function renderMenuList() {
    ...
    items.forEach((item) => {
      ...
      decBtn?.addEventListener("click", () => {
        ...
        syncMenuButtons();
        if (countEl)
          countEl.textContent = String(Math.max(itemQty(item.id), 0));
      });
